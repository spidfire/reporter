 ...
 *
 * @method     ChildCategoryQuery leftJoinAccountToCategory($relationAlias = null) Adds a LEFT JOIN clause to the query using the AccountToCategory relation
 * @method     ChildCategoryQuery rightJoinAccountToCategory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AccountToCategory relation
 * @method     ChildCategoryQuery innerJoinAccountToCategory($relationAlias = null) Adds a INNER JOIN clause to the query using the AccountToCategory relation
 *
 * @method     ChildCategoryQuery leftJoinCategoryToMetric($relationAlias = null) Adds a LEFT JOIN clause to the query using the CategoryToMetric relation
 * @method     ChildCategoryQuery rightJoinCategoryToMetric($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CategoryToMetric relation
 * @method     ChildCategoryQuery innerJoinCategoryToMetric($relationAlias = null) Adds a INNER JOIN clause to the query using the CategoryToMetric relation
 *
 * @method     \AccountToCategoryQuery|\CategoryToMetricQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'reporter', $modelName = '\\Category', $modelAlias = null)
    {
    ...
    public function filterByAccountToCategory($accountToCategory, $comparison = null)
    {
        if ($accountToCategory instanceof \AccountToCategory) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_ID, $accountToCategory->getCategoryId(), $comparison);
    ...
    public function filterByCategoryToMetric($categoryToMetric, $comparison = null)
    {
        if ($categoryToMetric instanceof \CategoryToMetric) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_ID, $categoryToMetric->getCategoryId(), $comparison);
