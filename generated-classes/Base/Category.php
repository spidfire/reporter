...
abstract class Category implements ActiveRecordInterface 
{
    ...
    public function setAccountToCategories(Collection $accountToCategories, ConnectionInterface $con = null)
    {
        ...
        foreach ($accountToCategoriesToDelete as $accountToCategoryRemoved) {
            $accountToCategoryRemoved->setCategory(null);
        }
    ...
    protected function doAddAccountToCategory(ChildAccountToCategory $accountToCategory)
    {
        ...
        $accountToCategory->setCategory($this);
    }
    ...
    public function removeAccountToCategory(ChildAccountToCategory $accountToCategory)
    {
        if ($this->getAccountToCategories()->contains($accountToCategory)) {
            ...
            $accountToCategory->setCategory(null);
        }
     ...
     * @return ObjectCollection|ChildAccountToCategory[] List of ChildAccountToCategory objects
     */
    public function getAccountToCategoriesJoinAccounts(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAccountToCategoryQuery::create(null, $criteria);
        $query->joinWith('Accounts', $joinBehavior);
    ...
    public function setCategoryToMetrics(Collection $categoryToMetrics, ConnectionInterface $con = null)
    {
        ...
        foreach ($categoryToMetricsToDelete as $categoryToMetricRemoved) {
            $categoryToMetricRemoved->setCategory(null);
        }
    ...
    protected function doAddCategoryToMetric(ChildCategoryToMetric $categoryToMetric)
    {
        ...
        $categoryToMetric->setCategory($this);
    }
    ...
    public function removeCategoryToMetric(ChildCategoryToMetric $categoryToMetric)
    {
        if ($this->getCategoryToMetrics()->contains($categoryToMetric)) {
            ...
            $categoryToMetric->setCategory(null);
        }
     ...
     * @return ObjectCollection|ChildCategoryToMetric[] List of ChildCategoryToMetric objects
     */
    public function getCategoryToMetricsJoinMetric(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCategoryToMetricQuery::create(null, $criteria);
        $query->joinWith('Metric', $joinBehavior);
